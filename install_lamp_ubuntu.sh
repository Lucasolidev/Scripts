...
# wget https://raw.githubusercontent.com/Lucasolidev/Scripts/main/install_lamp_ubuntu.sh -O install_lamp_ubuntu.sh && sudo chmod +x install_lamp_ubuntu.sh && sudo ./install_lamp_ubuntu.sh
# ==============================================================================
set -Eeuo pipefail
umask 077
STACK="lamp"
