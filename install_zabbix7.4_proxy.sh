...
# ==============================================================================
# Execução recomendada via repositório: lucasolidev install_zabbix7.4_proxy.sh
# ==============================================================================
# Baixar o script:
# wget https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7.4_proxy.sh
# curl -O https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7.4_proxy.sh
#
...
echo -e "${CIANO}[Etapa 1] Configurando repositório do Zabbix 7.4...${RESET}"
...
dpkg -i zabbix-release_latest_7.4+ubuntu26.04_all.deb > /dev/null
apt update
...
# 3. Preparar diretórios de log, runtime e aplicação de permissões
...
# OUTCOME VISUAL FINAL DO AGENTE E PROXY
echo -e "${VERDE}--------------------------------------------------------"
