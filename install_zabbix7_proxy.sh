...
# curl -O https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7_proxy.sh
#
...
# wget -qO- https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7_proxy.sh | sudo bash
# sudo bash <(wget -qO- https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7_proxy.sh)
# sudo bash <(curl -s https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7_proxy.sh)
# curl -fsSL https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7_proxy.sh | sudo bash
#
# ==============================================================================
