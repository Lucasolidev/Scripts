...
# wget -qO- https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7_proxy.sh | bash
# bash <(wget -qO- https://raw.githubusercontent.com/lucasolidev/scripts/main/install_zabbix7_proxy.sh)
